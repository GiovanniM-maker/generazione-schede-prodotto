// ---------------------------------------------------------------------------
// Nucleo dell'estrazione visiva. Questo file NON e' "use server", e non deve
// diventarlo.
//
// In Next ogni funzione esportata da un file "use server" e' un endpoint
// pubblico. Questo nucleo riceve `orgId` come PARAMETRO e usa il client di
// servizio, che scavalca le regole di accesso del database: esposto come
// endpoint avrebbe consentito di lavorare sui batch di un'altra
// organizzazione. Vivendo in un modulo normale non e' raggiungibile da fuori,
// e i controlli restano nell'azione che lo chiama.
// ---------------------------------------------------------------------------
